...
?>
			...
			<div class="container">
				...
				<h2>Latest Updates - Large Capitalized Companies (Large Caps)</h2>
				<div class="container">
				<!-- NEWS -->
        			...
        			$feeds = array("http://finance.yahoo.com/rss/headline?s=BIDU,CRM,DXC,INTC,AMZN,FB,ORCL,IBM,GOOGL,MSFT");
