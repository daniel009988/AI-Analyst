...
$portfoliocheck = $_POST['portfoliocheck'];
...
?>
	...
	<div class="container">
		<div class="container">
			...
			<p align="right"><a href="javascript:history.back()"><button type="button" class="btn btn-primary btn-sm">Go back</button></a>
					<a href="ai_analyst_portfoliocheck_print.php?portfoliocheck=<?php echo $portfoliocheck; ?>" target="_"><button type="button" class="btn btn-primary btn-sm">Print Compliance Report</button></a></p>
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				if ($top_symbol<>$row[Symbol]){
					echo '<td><a href="ai_analyst_home_stock_profile.php?stocksymbol=' . $top_symbol . '" class="btn btn-default btn-sm"><i class="fa fa-stack-exchange white"></i> Profile </a></td>';
				}
				if ($top_symbol===$row[Symbol]){
					echo '<td></td>';
				}
